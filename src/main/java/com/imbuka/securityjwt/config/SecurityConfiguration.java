...
import static com.imbuka.securityjwt.user.Role.ADMIN;
import static com.imbuka.securityjwt.user.Role.MANAGER;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        //securing the endpoint to be accessed by admin and manager only
